...
const aboutHeadSpaFAQs = [
  ...
  { question: "How long does a session last?", answer: "Sessions range from 60 to 90 minutes depending on the ritual you choose. The Gentleman's Recharge is 60 minutes, The Classic Ritual is 75 minutes, and both the Revitalize & Restore and Nourish & Fortify are 90-minute experiences. All sessions are appointment-only and reserved exclusively for you." },
...
const treatmentFAQs = [
  ...
  { question: "Are your products safe for color-treated hair?", answer: "Absolutely. Our Natulique products are certified organic, sulfate-free, and formulated to be gentle on color-treated hair. The Nourish & Fortify treatment actually helps strengthen and extend your color by reinforcing the hair's internal bonds." },
];
