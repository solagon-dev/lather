    ...
    <>
      ...
      <section className="section-pad bg-ivory">
        <div className="wrap grid items-center gap-14 lg:grid-cols-[1.1fr_1fr]">
          <Reveal>
            <p className="kicker-line">The Ritual</p>
            <h2 className="h-display mt-6 text-balance text-3xl sm:text-4xl">{service.introH2}</h2>
      ...
      <section className="grain relative section-pad bg-noir text-ivory">
        <div className="wrap relative">
          <Reveal className="max-w-2xl">
            <p className="kicker-line text-brass-light">What You Take Home</p>
            <h2 className="h-display mt-6 text-balance text-4xl sm:text-5xl">
              Five reasons guests <span className="italic text-brass-light">return</span>
            </h2>
          </Reveal>
      ...
      <section className="section-pad bg-porcelain">
        <div className="wrap">
          <Reveal>
            <p className="kicker-line">Why Lather</p>
            <h2 className="h-display mt-6 text-4xl sm:text-5xl">
              Built for <span className="italic">this</span>
            </h2>
          </Reveal>
        ...
        <div className="wrap grid gap-14 lg:grid-cols-[1fr_1.5fr]">
          <Reveal>
            ...
            <h2 className="h-display mt-6 text-balance text-3xl sm:text-4xl">
              Choose your <span className="italic">ritual</span>
            </h2>
      ...
      <section className="section-pad border-t hairline bg-porcelain">
        <div className="wrap">
          <Reveal className="flex flex-wrap items-end justify-between gap-6">
            <div>
              <p className="kicker-line">Related Reading</p>
            ...
            {service.relatedBlogs.map((b, i) => (
              <Reveal key={b.slug} delay={i * 80} className="h-full">
                <Link href={`/journal/${b.slug}`} className="group flex h-full flex-col border hairline bg-ivory p-8">
                  <p className="kicker-line">{b.category}</p>
                  <h3 className="h-display mt-5 flex-1 text-balance text-2xl transition-colors group-hover:text-brass-dark">
                    {b.title}
                  </h3>
      ...
      <section className="grain relative section-pad bg-noir text-ivory">
        <div className="wrap relative">
          <Reveal>
            <p className="kicker-line text-brass-light">Also Nearby</p>
            <h2 className="h-display mt-6 text-3xl sm:text-4xl">
              {service.shortLabel} for <span className="italic text-brass-light">your neighbors</span>
            </h2>
          </Reveal>
