...
export const locations: LocationData[] = [
  {
    ...
    city: "Greenville",
    state: "NC",
    metaTitle: "Luxury Head Spa in Greenville NC | Lather Spa & Wellness",
    metaDescription:
      "Lather Spa & Wellness is Greenville's premier spa & wellness destination, home to a signature Japanese-inspired head spa. Deep scalp care, stress relief, and whole-body wellness in Greenville, NC.",
    driveTime: null,
    distanceMiles: null,
    heroHeadline: "Greenville's Signature Japanese-Inspired Head Spa",
    heroSub:
      "Right here in Greenville, the head spa at Lather Spa & Wellness offers a Japanese-inspired sanctuary for scalp health and genuine relaxation. No long drives — just a quiet hour of exceptional care.",
    introTitle: "A Signature Head Spa at the Heart of Greenville",
    introBody: [
      "Lather Spa & Wellness is Greenville's premier spa & wellness destination, and its dedicated Japanese-inspired head spa is one of the signature services that put it on the map. Bringing a curated approach to scalp and hair wellness to the heart of eastern North Carolina, our doors are open whether you've been curious about the head spa experience or you're ready to make it a regular ritual — right here in your city.",
      "Our head spa protocol is designed around one simple belief: your scalp deserves the same thoughtful attention as the rest of your wellness routine. We combine professional-grade scalp analysis, deep cleansing techniques, targeted treatments, and prolonged massage into a single unbroken hour that leaves you genuinely restored.",
    ...
    whyVisit: [
      {
        ...
        body: "We're not a franchise or a pop-up concept. Lather Spa & Wellness was built for this community, and we're deeply invested in offering Greenville something it's never had before — a dedicated Japanese-inspired head spa, alongside a full spa & wellness destination, without having to leave town.",
      },
      {
    ...
    directionsText:
      "Lather Spa & Wellness is located in Greenville, NC, accessible from all parts of the city. From the university side of town, the medical district, or any of Greenville's surrounding neighborhoods, we're a short drive away. No tolls, no highway confusion — just a clean, easy trip to a genuinely restorative experience.",
    testimonialIndex: 0,
  },
  {
    ...
    city: "Winterville",
    state: "NC",
    metaTitle: "Head Spa Near Winterville NC | Lather Spa & Wellness Greenville",
    metaDescription:
      "Just 10 minutes from Winterville, Lather Spa & Wellness in Greenville NC offers a signature Japanese-inspired head spa, scalp treatments, and deep relaxation for Winterville residents.",
    driveTime: "about 10 minutes",
    distanceMiles: 5,
    heroHeadline: "Luxury Head Spa Near Winterville, NC",
    heroSub:
      "Winterville residents are just a short drive from one of eastern North Carolina's most thoughtful wellness experiences. Lather Spa & Wellness in Greenville is closer than you think.",
    introTitle: "Serving Guests from Winterville and the Greater Pitt County Area",
    introBody: [
      "For Winterville residents, Greenville has always been the natural destination for dining, shopping, and services. The Japanese-inspired head spa at Lather Spa & Wellness is simply the latest — and perhaps the most restorative — reason to make the trip. At just five miles away, a luxury head spa experience is genuinely within reach.",
    ...
    whyVisit: [
      {
        ...
        body: "You don't need to travel far for a world-class wellness experience. From Winterville, Lather Spa & Wellness is roughly ten minutes down the road — close enough to visit regularly, significant enough to feel like a true escape from routine.",
      },
      {
    ...
    directionsText:
      "From Winterville, Lather Spa & Wellness is a straightforward ten-minute drive into Greenville — no backroads or complicated turns required. Head north on Greenville Boulevard and you'll be pulling into Greenville before the first song on your playlist finishes. It's the kind of proximity that makes a luxury treatment feel like a spontaneous Tuesday decision rather than a special-occasion commitment.",
    testimonialIndex: 1,
  },
  {
    slug: "ayden-head-spa",
    city: "Ayden",
    state: "NC",
    metaTitle: "Head Spa Near Ayden NC | Lather Spa & Wellness Greenville",
    metaDescription:
      "Ayden residents are just 18 minutes from Lather Spa & Wellness in Greenville, NC — home to a signature Japanese-inspired head spa offering deep scalp treatments and genuine relaxation.",
    driveTime: "about 18 minutes",
    distanceMiles: 13,
    heroHeadline: "Luxury Head Spa Near Ayden, NC",
    heroSub:
      "From Ayden, a genuinely restorative head spa experience is less than twenty minutes away. Lather Spa & Wellness in Greenville is where scalp health and deep relaxation meet.",
    introTitle: "Welcoming Guests from Ayden to Greenville's Signature Head Spa",
    introBody: [
      "Ayden has a quiet charm that its residents know well — a pace of life that makes thoughtful self-care feel not just possible, but natural. And when it's time to seek out something a little more luxurious, Greenville is right up the road. Lather Spa & Wellness sits squarely at the intersection of those two impulses: the ease of staying close to home, and the reward of experiencing something genuinely elevated.",
    ...
    whyVisit: [
      {
        ...
        body: "Eighteen minutes separates Ayden from one of eastern North Carolina's most distinct wellness experiences. Lather Spa & Wellness offers a level of care and intention that guests often describe as genuinely unlike anything they've experienced at a traditional salon or spa.",
      },
      {
  ...
  },
  {
    ...
    city: "Farmville",
    state: "NC",
    metaTitle: "Head Spa Near Farmville NC | Lather Spa & Wellness Greenville",
    metaDescription:
      "Farmville residents are just 22 minutes from Lather Spa & Wellness in Greenville, NC — home to eastern NC's signature Japanese-inspired head spa for scalp health and deep relaxation.",
    driveTime: "about 22 minutes",
    distanceMiles: 18,
    heroHeadline: "Luxury Head Spa Near Farmville, NC",
    heroSub:
      "From Farmville, Greenville's signature head spa is only twenty minutes away. Lather offers Farmville residents a rare, unhurried experience in scalp care and total relaxation.",
    introTitle: "Bringing Luxury Head Spa Care to Farmville and Pitt County",
    introBody: [
      "Farmville sits comfortably in Pitt County's landscape — a community with deep roots and a growing appreciation for quality living. When it comes to the kind of personal care that goes beyond the ordinary, residents don't have to look far. Lather Spa & Wellness in Greenville is just eighteen miles down the road, and the experience waiting there is worth every mile.",
    ...
    whyVisit: [
      ...
      {
        title: "An Experience You Won't Find Nearby",
        body: "There's no dedicated Japanese-inspired head spa in eastern North Carolina quite like the one at Lather Spa & Wellness. For Farmville residents, making the short trip to Greenville is the way to access this level of scalp treatment and whole-body wellness.",
      },
      {
  ...
  },
  {
    ...
    city: "Washington",
    state: "NC",
    metaTitle: "Head Spa Near Washington NC | Lather Spa & Wellness Greenville",
    metaDescription:
      "Washington NC residents are about 40 minutes from Lather Spa & Wellness — home to Greenville's signature Japanese-inspired head spa. The drive is worth every minute for scalp care this good.",
    driveTime: "about 40 minutes",
    distanceMiles: 35,
    heroHeadline: "Luxury Head Spa Near Washington, NC",
    heroSub:
      "Washington's residents know a thing or two about beauty and intention — and those who've made the drive to Lather Spa & Wellness in Greenville say it's one of the best decisions they've made for their hair.",
    introTitle: "The Drive from Washington, NC to Greenville's Signature Head Spa",
    introBody: [
      "Washington, NC carries a quiet elegance — a riverfront city with a strong sense of place and an appreciation for quality. It's no surprise that residents with a discerning eye for exceptional experiences have begun making the trip to Lather Spa & Wellness in Greenville. The thirty-five-mile drive takes about forty minutes, and the experience waiting on the other end makes it more than worthwhile.",
  ...
  },
  {
    ...
    city: "New Bern",
    state: "NC",
    metaTitle: "Head Spa Near New Bern NC | Lather Spa & Wellness Greenville",
    metaDescription:
      "New Bern NC guests drive about 55 minutes to Lather Spa & Wellness in Greenville for a signature Japanese head spa and scalp treatments. A premium experience worth the journey.",
    driveTime: "about 55 minutes",
    distanceMiles: 47,
    heroHeadline: "Luxury Head Spa Near New Bern, NC",
    heroSub:
      "New Bern is a city that values quality and history — and its residents who've discovered Lather Spa & Wellness in Greenville have added a new chapter to their wellness story.",
    introTitle: "New Bern Guests Welcome at Lather Spa & Wellness in Greenville, NC",
    introBody: [
      "New Bern is one of North Carolina's most storied cities — a place where historical depth and contemporary living coexist gracefully. It's also home to discerning residents who, when they want something truly exceptional, are willing to drive for it. Lather Spa & Wellness in Greenville has become that destination for a growing number of New Bern guests who've discovered that the fifty-five minute drive is a worthwhile part of the experience.",
  ...
  },
  {
    ...
    city: "Grimesland",
    state: "NC",
    metaTitle: "Head Spa Near Grimesland NC | Lather Spa & Wellness Greenville",
    metaDescription:
      "Grimesland NC residents are just 10 minutes from Lather Spa & Wellness in Greenville — a signature Japanese-inspired head spa and scalp treatments for hair health and deep relaxation.",
    driveTime: "about 10 minutes",
    distanceMiles: 8,
    heroHeadline: "Luxury Head Spa Near Grimesland, NC",
    heroSub:
      "Just minutes from Grimesland, Lather Spa & Wellness in Greenville offers a Japanese-inspired sanctuary for scalp health and genuine relaxation. Your ritual is closer than you think.",
    introTitle: "Grimesland's Nearest Luxury Head Spa",
    introBody: [
      "Living in Grimesland means you're closer to Lather Spa & Wellness than almost anyone else in the region. Just eight miles down the road in Greenville, our studio offers a level of personal care that transforms how you think about scalp health and self-care.",
    ...
    directionsText:
      "The drive from Grimesland to Lather Spa & Wellness in Greenville is approximately ten minutes, heading west on NC-33 into Greenville. It's one of the shortest drives to our studio from any surrounding community — easy, direct, and effortless.",
    testimonialIndex: 2,
  },
  {
    ...
    city: "Wilson",
    state: "NC",
    metaTitle: "Head Spa Near Wilson NC | Lather Spa & Wellness Greenville",
    metaDescription:
      "Wilson NC residents drive about 55 minutes to Lather Spa & Wellness in Greenville for a signature Japanese head spa and scalp care. Discover why Wilson guests call it the best self-care decision they've made.",
    driveTime: "about 55 minutes",
    distanceMiles: 47,
    heroHeadline: "Luxury Head Spa Near Wilson, NC",
    heroSub:
      "Wilson has always been a city with character and ambition — and its residents who've found Lather Spa & Wellness in Greenville have found something worth the drive every single time.",
    introTitle: "Wilson, NC Guests Are Always Welcome at Lather Spa & Wellness",
    introBody: [
      "Wilson is a city that has long punched above its weight — in arts, in agriculture, in community character. Its residents are used to seeking out quality, even when it requires a bit of a drive. Lather Spa & Wellness in Greenville has become, for a growing number of Wilson guests, exactly that kind of destination: something specific enough and excellent enough to justify the trip.",
    ...
    whyVisit: [
      ...
      },
      {
        ...
        body: "At Lather, the head spa is a dedicated discipline — not a side service attached to a haircut or color. That focus means our team has developed a depth of expertise in scalp assessment and treatment that generalist salons simply can't match. Wilson guests appreciate coming to a place that truly specializes.",
      },
      {
  ...
  },
  {
    ...
    city: "Rocky Mount",
    state: "NC",
    metaTitle: "Head Spa Near Rocky Mount NC | Lather Spa & Wellness Greenville",
    metaDescription:
      "Rocky Mount NC residents are about 60 minutes from Lather Spa & Wellness in Greenville — home to a signature Japanese-inspired head spa offering expert scalp care and total relaxation.",
    ...
    introTitle: "Welcoming Rocky Mount Guests to Eastern NC's Signature Head Spa",
    introBody: [
      "Rocky Mount is a city at a compelling crossroads — urban and rural, historic and forward-looking. Its residents are accustomed to traveling for quality, and an increasing number have made Lather Spa & Wellness in Greenville a regular destination on their wellness calendar. At fifty-six miles away, it's the kind of drive that feels purposeful rather than burdensome, especially when you know exactly what's waiting at the other end.",
      "The concept of a dedicated head spa — a ritual focused entirely on the health of the scalp and the deep relaxation of the body through prolonged massage — is still relatively rare outside of major metropolitan areas. Lather brought one to eastern North Carolina as a signature part of its spa & wellness destination. Our mission has always been to bring the quality and intention of a world-class head spa experience to people who shouldn't have to drive to Raleigh or Charlotte to access it.",
    ...
    whyVisit: [
      ...
      },
      {
        ...
        body: "Unlike a spa that offers scalp massage as an add-on, Lather's head spa was built around scalp health from the ground up. Every session includes a professional assessment, a customized cleanse, targeted treatment application, and an extended massage. It's a full protocol, not a partial gesture.",
      },
      {
